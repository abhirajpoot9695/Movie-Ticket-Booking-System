...
const DateSelect = ({dateTime,id}) => {
  ...
  return (
    ...
    <div id='dateSelect' className='pt-30' >
         ...
         <div>
            ...
            gap-4'>
                {Object.keys(dateTime).map((date)=>(
                    ...
                    justify-center h-14 aspect-square rounded-1.5xl
                    cursor-pointer ${selected === date ? "bg-red-600 text-white border-red-600" : "border border-primary/70  "}`}>
        ...
        hover:bg-red-500 transition-all cursor-pointer'>Book Now</button>
        </div> 
