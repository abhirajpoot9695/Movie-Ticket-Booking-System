...
const Navbar = () => {
  ...
  return (
    ...
    <div className={`max-md:absolute max-md:top-0 max-md :left-0 max-md:font-medium
        max-md:text-lg z-50 flex flex-col md:flex-row item-center
        max-md:justify-center gap-8 min-md:px-8 py-3 max-md:h-screen
        min-md:rounded-full backdrop-blur bg-blacl/70 md:bg-white/10 md:border
    ...
    <div className = 'flex item-center gap-8'>
        ...
        { !user ? (
          ...
          hover:big-primary-dull transition rounded-full front-medium
